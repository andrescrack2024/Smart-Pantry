...
# 1. Update imports to include useColorScheme
old_imports = """import { 
...
# 2. Update state hooks: replace isDarkMode state with themeMode state
code = code.replace("const [isDarkMode, setIsDarkMode] = useState(false);",
                    "const [themeMode, setThemeMode] = useState('system'); // 'light' | 'dark' | 'system'")

# 3. Update useEffect loadLocalProfile to load themeMode
...
code = code.replace(old_load_mode, new_load_mode)

# 4. Remove toggleDarkMode and insert changeThemeMode
...
code = code.replace(old_toggle_function, new_toggle_function)

# 5. Update derived theme variables right above return block
...
code = code.replace(old_derived_theme, new_derived_theme)

# 6. Update theme switch UI settings in Perfil Settings Card
...
code = code.replace(old_settings_switch, new_settings_switch)

# 7. Update Android Share Sheet Modal JSX to be fully theme-aware
old_share_modal_jsx = """      {/* --- MODAL DE COMPARTIR CÓDIGO FAMILIAR (Modern Android Material You Dark-Theme Share Sheet) --- */}
      <ModalWrapper visible={showShareModal} animationType="slide" transparent={true} onRequestClose={() => setShowShareModal(false)}>
        <TouchableOpacity 
          style={styles.shareOverlayAndroid} 
          activeOpacity={1} 
          onPress={() => setShowShareModal(false)}
        >
          <View style={styles.shareSheetMainAndroid} {...sharePanResponder.panHandlers}>
            <View style={styles.shareSheetHandleAndroid} />
            
            {/* Title */}
            <Text style={styles.shareSheetTitleAndroid}>Compartir Código</Text>
            
            {/* Preview Card */}
            <View style={styles.sharePreviewCardAndroid}>
              <View style={[styles.sharePreviewIconBox, { backgroundColor: themeColor }]}>
                <Ionicons name="people" size={24} color="#fff" />
              </View>
              <View style={styles.sharePreviewTextColumn}>
                <Text style={styles.sharePreviewTitle}>Despensa Familiar SmartPantry</Text>
                <Text style={styles.sharePreviewSubtitle}>Código: {userProfile.familyCode}</Text>
              </View>
            </View>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.shareContactsScrollAndroid}>
              ...
              <TouchableOpacity style={styles.shareContactItemAndroid} onPress={copyFamilyCode}>
                <View style={styles.shareContactAvatarWrapperAndroid}>
                  <View style={[styles.shareContactAvatarAndroid, { backgroundColor: '#1A5F35' }]}>
                    <Ionicons name="volume-high" size={22} color="#fff" />
                  </View>
                  <View style={[styles.shareContactBadgeAndroid, { backgroundColor: '#25D366' }]}>
                    <Ionicons name="logo-whatsapp" size={10} color="#fff" />
                  </View>
                </View>
                <Text style={styles.shareContactNameAndroid} numberOfLines={2}>GP MOBILE</Text>
              </TouchableOpacity>

              {/* La Familia */}
              <TouchableOpacity style={styles.shareContactItemAndroid} onPress={copyFamilyCode}>
                <View style={styles.shareContactAvatarWrapperAndroid}>
                  <View style={[styles.shareContactAvatarAndroid, { backgroundColor: '#B04E36' }]}>
                ...
                <Text style={styles.shareContactNameAndroid} numberOfLines={2}>La Familia 😍</Text>
              </TouchableOpacity>

              {/* Tío Siete */}
              <TouchableOpacity style={styles.shareContactItemAndroid} onPress={copyFamilyCode}>
                <View style={styles.shareContactAvatarWrapperAndroid}>
                  <View style={[styles.shareContactAvatarAndroid, { backgroundColor: '#473680' }]}>
                ...
                <Text style={styles.shareContactNameAndroid} numberOfLines={2}>Tío Siete</Text>
              </TouchableOpacity>

              {/* Nando Abuelo */}
              <TouchableOpacity style={styles.shareContactItemAndroid} onPress={copyFamilyCode}>
                <View style={styles.shareContactAvatarWrapperAndroid}>
                  <View style={[styles.shareContactAvatarAndroid, { backgroundColor: '#1A4F7C' }]}>
                    <Text style={{ color: '#fff', fontSize: 14, fontWeight: '800' }}>NA</Text>
                  </View>
                  <View style={[styles.shareContactBadgeAndroid, { backgroundColor: '#007AFF' }]}>
                    <Ionicons name="chatbubble" size={9} color="#fff" />
                  </View>
                </View>
                <Text style={styles.shareContactNameAndroid} numberOfLines={2}>Nando Abuelo</Text>
              </TouchableOpacity>

              {/* Nota Personal */}
              <TouchableOpacity style={styles.shareContactItemAndroid} onPress={copyFamilyCode}>
                <View style={styles.shareContactAvatarWrapperAndroid}>
                  <View style={[styles.shareContactAvatarAndroid, { backgroundColor: '#64748B' }]}>
                ...
                <Text style={styles.shareContactNameAndroid} numberOfLines={2}>Nota personal</Text>
              </TouchableOpacity>
            </ScrollView>
            
            <View style={styles.shareDividerAndroid} />
            ...
            <View style={styles.shareAppsGridAndroid}>
              ...
              <TouchableOpacity style={styles.shareAppItemAndroid} onPress={copyFamilyCode}>
                ...
                <Text style={styles.shareAppNameAndroid}>Quick Share</Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text style={styles.shareAppNameAndroid}>WhatsApp</Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text style={styles.shareAppNameAndroid}>Telegram</Text>
              </TouchableOpacity>

              {/* Gemini */}
              <TouchableOpacity style={styles.shareAppItemAndroid} onPress={copyFamilyCode}>
                <View style={[styles.shareAppIconBoxAndroid, { backgroundColor: '#F2F2F7', borderWidth: 1.5, borderColor: '#D1D1D6' }]}>
                  <Ionicons name="sparkles" size={24} color="#34C759" />
                </View>
                <Text style={styles.shareAppNameAndroid}>Gemini</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.shareAppItemAndroid} onPress={copyFamilyCode}>
                ...
                <Text style={styles.shareAppNameAndroid}>DeepSeek</Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.shareAppsGridAndroid}>
              {/* Copiar Código */}
              <TouchableOpacity style={styles.shareAppItemAndroid} onPress={copyFamilyCode}>
                <View style={[styles.shareAppIconBoxAndroid, { backgroundColor: '#3A3A3C' }]}>
                  <Ionicons name="copy" size={24} color="#fff" />
                </View>
                <Text style={styles.shareAppNameAndroid}>Copiar</Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text style={styles.shareAppNameAndroid}>Gmail</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.shareAppItemAndroid} onPress={copyFamilyCode}>
                ...
                <Text style={styles.shareAppNameAndroid}>Discord</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.shareAppItemAndroid} onPress={() => {
                ...
                <View style={[styles.shareAppIconBoxAndroid, { backgroundColor: '#636366' }]}>
                  <Ionicons name="refresh" size={24} color="#fff" />
                </View>
                <Text style={styles.shareAppNameAndroid}>Regenerar</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity style={styles.shareAppItemAndroid} onPress={() => setShowShareModal(false)}>
                ...
                <Text style={styles.shareAppNameAndroid}>Cerrar</Text>
              </TouchableOpacity>
            </View>
          </View>
        </TouchableOpacity>
...
code = code.replace(old_share_modal_jsx, new_share_modal_jsx)

# 8. Add themeModePill styles to Stylesheet
...
print("System and dynamic share sheet themes applied successfully!")
